...
def mainapp():
    ...
    topbanner.place(relheight = 1, relwidth = 1, relx = 0.5,rely = 0.086,anchor = CENTER)
    #topbanner.pack(fill=BOTH, expand=YES)
    ...
    def resize_image(event):
        ...
        #banner_pic_copy = CTkImage(Image.open('assets/banner2.png'), size = (new_width, new_height))
    ...
    booking_bg = CTkImage(Image.open('assets/utbg0.png'),size = (1440,720))
        ...
        def select_misc():
            ...
            def show_details():
                ...
                def book():
                    ...
                    recpic = CTkLabel(rec,text = '', image = booking_bg)
                    recpic._image = booking_bg
