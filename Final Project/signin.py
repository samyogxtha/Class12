...
from customtkinter import CTk, CTkCanvas, CTkEntry, CTkLabel, CTkButton


OUTPUT_PATH = Path(__file__).parent
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\Samyog\OneDrive\Documents\Class12\Final Project\signup\assets\frame0")
